...
| ClawHub | Published | Latest published version is `douyin-web-control@0.1.3` under `billwang233`. `clawhub inspect douyin-web-control` reports moderation `CLEAN`. |
...
npx clawhub@latest publish skills/douyin-web-control \
  ...
  --changelog "Require agents to pause for user login, captcha, and account-risk verification."
```
